...
const OurStudents = () => {
    return (
        <div className=" w-full h-screen mt-36 " style={{
            ...
            <div className="w-full max-h-screen min-h-screen px-36 backdrop-blur-sm flex justify-evenly items-center gap-20">
                <div className=" text-white ">

                    <h1 className=" text-white text-2xl font-bold mb-5">Our Classes</h1>
                    <h1 className=" text-4xl font-extrabold">About School</h1>

                    <p className=" text-xl font-bold my-5">Integer in justo euismod nulla feugiat lacinia non porta velit. Vestibulum vulputate purus sit amet vestibulum ultrices mauris malesuada.</p>

                    <p className=" mb-6 text-gray-200">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elementum sem ligula. Phasellus eleifend vel justo sit amet volutpat. Duis vitae maximus ligula, nec mattis libero. Donec eget felis odio.</p>
